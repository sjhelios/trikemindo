...
echo '<p class="page_title_text">
		<img src="'.$RootPath.'/css/'.$Theme.'/images/supplier.png" title="' . _('Receive') . '" alt="" />' . ' ' . _('Receive Purchase Order') . ' : '. $_SESSION['PO'.$identifier]->RequisitionNo .' '. _('from'). ' ' . $_SESSION['PO'.$identifier]->SupplierName . '</p>';
...
if (!isset($_POST['ProcessGoodsReceived'])) {
	...
	echo '<table class="selection">
			<tr>
				<tr>
					<td>' .  _('Goods Receive Note (GRN) No'). ':  '. $_SESSION['PO'.$identifier]->OrderNo .'</td>
				</tr>
...
/**/		
	echo '<br />
			<div class="centre">
				<input type="submit" name="ShowGoodsReceived" value="'._('Show on Screen').'" />
			</div>';	
}
echo '</div>';
echo '</form>';
