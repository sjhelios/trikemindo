...
echo '<tr>
		<td>' . _('COA') . ' (' . _('Certificate of Analysis') . '):</td>
...
// product "Category" section (original position)
/*echo '<tr>
		<td>' . _('Category') . ':</td>
		<td><select name="CategoryID" onchange="ReloadForm(ItemForm.UpdateCategories)">';
...
// end of "Category" (original position)
...
/*echo '<tr>
		<td>' . _('Unit 2: Packaged Net Weight (KGs)') . ':</td><td><input ' . (in_array('NetWeight',$Errors) ?  'class="inputerror"' : '' ) .'   type="text" class="number" name="NetWeight" size="12" maxlength="10" value="' . locale_number_format($_POST['NetWeight'],'Variable') . '" /></td>
	</tr>';

	echo '<tr>
		<td>' . _('Unit 2: Packaged Units') . ':</td>
...
echo '</select></td>
	...
	/*<td>' . _('Purchase, Asmbly, Kit, Manufac. or Srv/Labour') . ':</td>*/
	/*<td>' . _('Transaction Type') . ':</td>*/
echo '<tr>
		<td>' . _('Purchase, or Agent/Service') . ':</td>
...
/*Service/Labour (Original selection) change to Agent/Service*/
if (isset($_POST['MBFlag']) AND $_POST['MBFlag']=='D'){
	echo '<option selected="selected" value="D">' . _('Agent/Service') . '</option>';
} else {
	echo '<option value="D">' . _('Agent/Service') . '</option>';
}

echo '</select></td>
	</tr>';
// Current or Discontinued section script
echo '<tr>
...
// end of Current/Discontinued section

// beginning script "Batch,Lot" section
echo '<tr>
...
echo '</select></td></tr>';
	// beginning script "Serialised" section
...
// end of Unit 2 section script
	
// start Unit 3 section script	
	echo '<tr>
		<td>' . _('Unit 3 : Qty Package / Pallete') . ':</td><td><input ' . (in_array('GrossWeight',$Errors) ?  'class="inputerror"' : '' ) .'   type="text" class="number" name="GrossWeight" size="12" maxlength="10" value="' . locale_number_format($_POST['GrossWeight'],'Variable') . '" /></td>
	</tr>';
	echo '<tr>
		<td>' . _('Unit 3: Packaged Units') . ':</td>
		<td><select ' . (in_array('Description',$Errors) ?  'class="selecterror"' : '' ) .'  name="Units">';
