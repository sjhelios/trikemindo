...
Class PurchOrder {
	...
	var $Contact;
	var $Port;
	/* adding PurchOder class */
	var $Ponumb;
	var $ShipmentTermsName;
	var $Insurance;
	var $CountryOrigin;
	var $SuppType;	// added additional class in for PurchOrder class - by S 01-06-2015
	var $SuppTypeID; // added additional class in PurchOrder class - by S 01-06-2015
	/* end of adding PurchOder class */
	function PurchOrder(){
