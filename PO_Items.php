 ...
 */
	if ($InputError!=1){
		...
		if ($_SESSION['ExistingOrder']==0){ /*its a new order to be inserted */
			...
			/*Get the order number section by TJ*/
		...
		/*	$sqlsupptype = "SELECT supptype FROM suppliers WHERE supplierid='" . $_POST['SuppType'] . "'";
			...
			// if impor, get order no yg impor
		/*	if($_POST['SuppType']==1)
			{
				$Ponumb="PO/TU-IM/";
				$_SESSION['PO' . $identifier]->Ponumb;	
			} 
			//elseif getorder no yg lokal
			else if($_POST['SuppType']==2)
			{ 
				$Ponumb="PO/TU-L/";
				$_SESSION['PO' . $identifier]->Ponumb;	
			}	*/
			...
			$sql = "INSERT INTO purchorders ( orderno,
							...
							VALUES(	'" . $_SESSION['PO'.$identifier]->OrderNo . "',
									...
									'" . $_SESSION['PO'.$identifiers]->Version . "',
									'" . Date('Y-m-d') . "',
									...
									'" . $_SESSION['PO'.$identifier]->SuppType . "',
									'" . $_SESSION['PO'.$identifier]->AllowPrintPO . "')";

			$ErrMsg =  _('The purchase order header record could not be inserted into the database because');
			$DbgMsg = _('The SQL statement used to insert the purchase order header record and failed was');
			$result = DB_query($sql,$ErrMsg,$DbgMsg,true);
			/* '" . $_SESSION['PO'.$identifier]->SuppType . "',*/ // passing SuppType for selected SupplierID storing into Puchorder table - supptypeid field - by S 03-06-2015 01:30 am
			...
			$sql = "UPDATE purchorders SET supplierno = '" . $_SESSION['PO'.$identifier]->SupplierID . "' ,
										...
										shipmenttermsname='" . $_SESSION['PO'.$identifier]->ShipmentTermsName . "',
										insurance='" . $_SESSION['PO'.$identifier]->Insurance . "',
										countryorigin='" . $_SESSION['PO'.$identifier]->CountryOrigin . "',
										supptypeid = '" . $_SESSION['PO'.$identifier]->SuppTypeID . "' ,
...
if (count($_SESSION['PO'.$identifier]->LineItems)>0 and !isset($_GET['Edit'])){
	echo '<p class="page_title_text"><img src="'.$RootPath.'/css/'.$Theme.'/images/supplier.png" title="' .
		_('Purchase Order') . '" alt="" />  '.$_SESSION['PO'.$identifier]->SupplierName. '<br/>';

/*	if (isset($_SESSION['PO'.$identifier]->OrderNo)) {
		echo  ' ' . _('Purchase Order') .' '. $_SESSION['PO'.$identifier]->OrderNo ;	*/
	if (isset($_SESSION['PO'.$identifier]->Ponumb)) {
		echo  ' ' . _('Purchase Order:') .' '. $_SESSION['PO'.$identifier]->Ponumb ;
	}

	echo '<table class="selection" cellpadding="2" style="width:100%">
			<tbody>
			<tr>
				<th><h3>' . _('To (Supplier):') . '</h3></th>
				<th><h3>' . _('Deliver To (Warehouse):') . '</h3></th>
			</tr>
	...
	echo 	'<tr>
				...
				<td>'. $_SESSION['PO' . $identifier]->SupplierContact . '</td>
			</tr>

			<tr>
				<td> SupplierName </td>
				<td>'. $_SESSION['PO' . $identifier]->SupplierName . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd1 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd1 . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd2 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd2 . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd3 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd3 . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd4 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd4 . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd5 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd5 . '</td>
			</tr>

			<tr>
				<td> SuppDelAdd6 </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppDelAdd6 . '</td>
			</tr>

			<tr>
				<td> SuppTel </td>
				<td>'. $_SESSION['PO' . $identifier]->SuppTel . '</td>
			</tr>';

			// <tr>
			// 	<td> Initiator </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->Initiator . '</td>
			// </tr>

			// <tr>
			// 	<td> Requisition </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->Requisition . '</td>
			// </tr>

			// <tr>
			// 	<td> Version </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->Version . '</td>
			// </tr>
	...
	echo 	'<td style="width:50%"><table class="selection" width="100%">';
	echo	'<tr>
				<td> StkLocation </td>
				<td>'. $_SESSION['PO' . $identifier]->StkLocation . '</td>
			</tr>

			<tr>
				<td> DelAdd1 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd1 . '</td>
			</tr>

			<tr>
				<td> DelAdd2 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd2 . '</td>
			</tr>

			<tr>
				<td> DelAdd3 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd3 . '</td>
			</tr>

			<tr>
				<td> DelAdd4 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd4 . '</td>
			</tr>

			<tr>
				<td> DelAdd5 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd5 . '</td>
			</tr>

			<tr>
				<td> DelAdd6 </td>
				<td>'. $_SESSION['PO' . $identifier]->DelAdd6 . '</td>
			</tr>

			<tr>
				<td> Tel </td>
				<td>'. $_SESSION['PO' . $identifier]->Tel . '</td>
			</tr>

			<tr>
				<td> Contact </td>
				<td>'. $_SESSION['PO' . $identifier]->Contact . '</td>
			</tr>

			<tr>
				<td> DeliveryBy </td>
				<td>'. $_SESSION['PO' . $identifier]->DeliveryBy . '</td>
			</tr>';

			// <tr>
			// 	<td> DeliveryDate </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->DeliveryDate . '</td>
			// </tr>

			// <tr>
			// 	<td> Revised </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->Revised . '</td>
			// </tr>

			// <tr>
			// 	<td> ExRate </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->ExRate . '</td>
			// </tr>

			// <tr>
			// 	<td> Comments </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->Comments . '</td>
			// </tr>
		

			// <tr>
			// 	<td> StatusComments </td>
			// 	<td>'. $_SESSION['PO' . $identifier]->StatusComments . '</td>
			// </tr>
	...
	echo '</tbody></table>';//end table warehouse and supplier

	//start shipment details
	echo '<table class="selection" cellpadding="2" style="width:100%">
		<tbody>
		<tr>
			<th><h3>' . _('Shipment Details:') . '</h3></th>
			<th><h3>' . _('Comments/Remarks') . '</h3></th>
		</tr>
		<tr><td style="width:50%">';
	...
	echo 	'<tr>
				<td> PaymentTerms </td>
				<td>'. $_SESSION['PO' . $identifier]->PaymentTerms . '</td>
			</tr>

			<tr>
				<td> Port</td>
				<td>'. $_SESSION['PO' . $identifier]->Port . '</td>
			</tr>

			<tr>
				<td> Ponumb </td>
				<td>'. $_SESSION['PO' . $identifier]->Ponumb . '</td>
			</tr>

			<tr>
				<td> Insurance </td>
				<td>'. $_SESSION['PO' . $identifier]->Insurance . '</td>
			</tr>

			<tr>
				<td> ShipmentTermsName </td>
				<td>'. $_SESSION['PO' . $identifier]->ShipmentTermsName . '</td>
			</tr>

			<tr>
				<td> CountryOrigin </td>
				<td>'. $_SESSION['PO' . $identifier]->CountryOrigin . '</td>
			</tr>';
	echo '</table></td>';
	//end table shipment details
