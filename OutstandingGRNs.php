...
/*Now figure out the data to report for the criteria under review */
	...
	$SQL = "SELECT grnno,
					...
					purchorderdetails.requisitionno, /* add*/
					grns.supplierid,
					suppliers.suppname,
					grns.itemcode,
...
/*Print out the grand totals */
	...
	echo '<div class="page_help_text">' . _('Shows the list of goods received not yet invoiced, both in supplier currency and home currency. When run for all suppliers, the total in home currency should match the GL Account for Goods received not invoiced.') . '</div>';
